...
jQuery(window).load(function () {
  jQuery("ul.gallery li.gallerybox").each(function() { 
	var newlink = 	jQuery("div.gallerytext a", this).attr('href'); 
	if(newlink)
	{
		jQuery("div.thumb a.image", this).attr('href', newlink).attr('target', '_blank').removeAttr('rel');
		jQuery("div.thumb a.image", this).unbind();	
	}
